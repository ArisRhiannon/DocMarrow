...
```bash
pnpm build                              # build docparse-ts first
pnpm --filter @docparse/playground dev  # open the printed localhost URL
```
...
Build a static bundle with `pnpm --filter @docparse/playground build`.
